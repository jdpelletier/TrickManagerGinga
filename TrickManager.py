...
class FitsViewer(QtGui.QMainWindow):
    ...
    def full_frame_mode(self):
        ...
        self.fitsimage.get_canvas().delete_object_by_tag(self.crosstag)
        self.resize(500, 700)
        self.viewerLspacer.changeSize(40, 0, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.viewerRspacer.changeSize(40, 0, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
