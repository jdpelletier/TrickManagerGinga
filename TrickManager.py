...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger):
        ...
        self.viewerLspacer = QtGui.QSpacerItem(40, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        viewer_hbox.addItem(self.viewerLspacer)
        w = fi.get_widget()
        w.setMinimumSize(QtCore.QSize(240, 240))
        viewer_hbox.addWidget(w, stretch=1)
        self.viewerRspacer = QtGui.QSpacerItem(40, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
