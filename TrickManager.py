...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger):
        ...
        self.viewerLspacer = QtGui.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        viewer_hbox.addWidget(self.viewerLspacer)
        w = fi.get_widget()
        w.setMinimumSize(QtCore.QSize(240, 240))
        viewer_hbox.addWidget(w, stretch=1)
        self.viewerRspacer = QtGui.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        viewer_hbox.addWidget(self.viewerRspacer)
        hw = QtGui.QWidget()
