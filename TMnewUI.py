...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger, MainWindow):
        ...
        self.roi_hbox = QtGui.QHBoxLayout()
        ...
        self.buttons_vbox_left = QtGui.QVBoxLayout()
        self.buttons_vbox_left.setObjectName("buttons_vbox_left")
        spacerItem = QtGui.QSpacerItem(105, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        self.wvidemode = QtGui.QPushButton("Video Mode")
        ...
        self.buttons_vbox_mid = QtGui.QVBoxLayout()
        ...
        self.image_info_vbox = QtGui.QVBoxLayout()
        ...
        self.buttons_vbox_right = QtGui.QVBoxLayout()
