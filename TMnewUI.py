...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger, MainWindow):
        ...
        self.viewer_hbox = QtWidgets.QHBoxLayout()
        self.viewer_hbox.setObjectName("viewer_hbox")
        w = fi.get_widget()
        w.resize(240, 240)
        self.viewer_hbox.addWidget(w)
        self.vbox.addLayout(self.viewer_hbox)
        self.readout_hbox = QtWidgets.QHBoxLayout()
        self.readout_hbox.setObjectName("readout_hbox")
        self.readout = QtWidgets.QLabel("X:                 Y:                    Value:")
        self.readout.setObjectName("readout")
        self.readout.setMinimumSize(QtCore.QSize(350, 0))
        self.readout_hbox.addWidget(self.readout)
        ...
        self.readout_hbox.addWidget(self.wcut)
        ...
        self.readout_hbox.addWidget(self.wcolor)
        self.wcolor.setVisible(False)
        self.vbox.addLayout(self.readout_hbox)
        self.roi_hbox = QtWidgets.QHBoxLayout()
        self.roi_hbox.setObjectName("roi_hbox")
        self.roi_info = QtWidgets.QLabel("ROI: ")
        self.roi_info.setObjectName("roi_info")
        self.roi_hbox.addWidget(self.roi_info)
        self.box_readout = QtWidgets.QLabel("Amplitude:                  FWHM: ")
        ...
        self.buttons_vbox_left = QtWidgets.QVBoxLayout()
        self.buttons_vbox_left.setObjectName("buttons_vbox_left")
        spacerItem = QtWidgets.QSpacerItem(105, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.buttons_vbox_left.addItem(spacerItem)
        self.wfullframemode = QtWidgets.QPushButton("Full Frame Mode")
        self.wfullframemode.setObjectName("wfullframemode")
        self.wfullframemode.clicked.connect(self.full_frame_mode)
        self.buttons_vbox_left.addWidget(self.wfullframemode)
        self.wtakeff = QtWidgets.QPushButton("Take Full Frame")
        self.wtakeff.setObjectName("wtakeff")
        self.wtakeff.clicked.connect(self.take_ff)
        self.wtakeff.setVisible(False)
        self.buttons_vbox_left.addWidget(self.wtakeff)
        self.wvidemode = QtWidgets.QPushButton("Video Mode")
        self.wvidemode.setObjectName("wvidemode")
        self.wvideomode.clicked.connect(self.video_mode)
        self.wvideomode.setVisible(False)
        self.buttons_vbox_left.addWidget(self.wvideomode)
        self.buttons_hbox.addLayout(self.buttons_vbox_left)
        self.buttons_vbox_mid = QtWidgets.QVBoxLayout()
        self.buttons_vbox_mid.setObjectName("buttons_vbox_mid")
        self.wrestartvideo = QtWidgets.QPushButton("Restart Video")
        self.wrestartvideo.setObjectName("wrestartvideo")
        self.wrestartvideo.clicked.connect(self.restart_video)
        self.buttons_vbox_mid.addWidget(self.wrestartvideo)
        self.wreboottrick = QtWidgets.QPushButton("Reboot Trick")
        self.wreboottrick.setObjectName("wreboottrick")
        self.wreboottrick.clicked.connect(self.reboot_trick)
        self.buttons_vbox_mid.addWidget(self.wreboottrick)
        self.wsetroi = QtWidgets.QPushButton("Set ROI")
        self.wsetroi.setObjectName("wsetroi")
        self.wsetroi.clicked.connect(self.set_roi)
        self.wsetroi.setVisible(False)
        self.buttons_vbox_mid.addWidget(self.wsetroi)
        self.wsky = QtGui.QPushButton("Load Sky")
        self.wsky.clicked.connect(self.load_sky)
        self.wsky.setVisible(False)
        self.wsky.setVisible(False)
        self.buttons_vbox_mid.addWidget(self.wsky)
        self.buttons_hbox.addLayout(self.buttons_vbox_mid)
        self.image_info_vbox = QtWidgets.QVBoxLayout()
        self.image_info_vbox.setObjectName("image_info_vbox")
        self.sky_info = QtWidgets.QLabel("Sky: ")
        self.sky_info.setObjectName("sky_info")
        self.sky_info.setVisible(False)
        self.image_info_vbox.addWidget(self.sky_info)
        self.filt_info = QtWidgets.QLabel("Filter: ")
        self.filt_info.setObjectName("filt_info")
        self.filt_info.setVisible(False)
        self.image_info_vbox.addWidget(self.filt_info)
        self.image_info = QtWidgets.QLabel("Image: ")
        ...
        self.image_info_vbox.addWidget(self.image_info)
        self.buttons_hbox.addLayout(self.image_info_vbox)
        self.buttons_vbox_right = QtWidgets.QVBoxLayout()
        self.buttons_vbox_right.setObjectName("buttons_vbox_right")
        self.winittrick = QtWidgets.QPushButton("Init Trick")
        ...
        self.wopen = QtWidgets.QPushButton(self.widget)
        self.wopen.setObjectName("wopen")
        self.wopen.clicked.connect(self.open_file)
        self.wopen.setVisible(False)
        self.buttons_vbox_right.addWidget(self.wopen)
        self.wquit = QtWidgets.QPushButton("Quit")
        self.wquit.setObjectName("wquit")
        self.wquit.clicked.connect(self.quit)
        self.buttons_vbox_right.addWidget(self.wquit)
        self.buttons_hbox.addLayout(self.buttons_vbox_right)
