...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger, MainWindow):
        ...
        self.vid_hbox_layout = QtWidgets.QWidget(self.centralwidget)
        self.vid_hbox_layout.setGeometry(QtCore.QRect(9, 9, 381, 231))
        self.vid_hbox_layout.setObjectName("vid_hbox_layout")
        self.vid_display_hbox = QtWidgets.QHBoxLayout(self.vid_hbox_layout)
        self.vid_display_hbox.setContentsMargins(0, 0, 0, 0)
        self.vid_display_hbox.setObjectName("vid_hbox_layout")
        self.ff_hbox_layout = QtGui.QWidget(self.centralwidget)
        self.ff_hbox_layout.setGeometry(QtCore.QRect(0, 0, 701, 511))
        self.ff_hbox_layout.setObjectName("ff_hbox_layout")
        self.ff_display_hbox = QtGui.QHBoxLayout(self.ff_hbox_layout)
        self.ff_display_hbox.setContentsMargins(0, 0, 0, 0)
        self.ff_display_hbox.setObjectName("ff_display_hbox")
        self.ff_display_hbox.setVisible(False)
        w = fi.get_widget()
        w.setObjectName("w")
        ...
        self.vid_readout = QtWidgets.QLabel(self.centralwidget)
        self.vid_readout.setGeometry(QtCore.QRect(30, 240, 251, 16))
        self.vid_readout.setObjectName("readout")
        self.vid_roi_info = QtWidgets.QLabel(self.centralwidget)
        self.vid_roi_info.setGeometry(QtCore.QRect(20, 270, 71, 20))
        self.vid_roi_info.setObjectName("roi_info")
        ...
        self.wrestartvideo.setGeometry(QtCore.QRect(150, 310, 93, 28))
        ...
        self.winittrick.setGeometry(QtCore.QRect(290, 250, 93, 28))
        ...
        self.wreboottrick.setGeometry(QtCore.QRect(290, 280, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.vid_readout.setText(_translate("MainWindow", "X:                 Y:                    Value:"))
        self.vid_roi_info.setText(_translate("MainWindow", "f\"ROI {self.trickxpos.read()} {self.trickypos.read()}"))
        self.ff_roi_info.setText(_translate("MainWindow", "f\"ROI {self.trickxpos.read()} {self.trickypos.read()}"))
        ...
        self.ff_readout.setText(_translate("MainWindow", "X:                 Y:                    Value:"))
    ...
    def full_frame_mode(self):
        ...
        self.wreboottrick.setVisible(False)
        self.vid_display_hbox.setVisible(False)
        self.vid_roi_info.setVisible(True)
        self.vid_readout.setVisible(True)
        self.ff_display_hbox.setVisible(True)
        ...
        self.ff_roi_info.setVisible(True)
        self.ff_readout.setVisible(True)
        self.start_scan()
        self.mode = 'fullframe'
    ...
    def video_mode(self):
        ...
        self.ff_display_hbox.setVisible(False)
        self.vid_display_hbox.setVisible(True)
        ...
        self.vid_roi_info.setVisible(False)
        self.vid_readout.setVisible(False)
        self.wsky.setVisible(False)
        self.wtakeff.setVisible(False)
        self.wsetroi.setVisible(False)
        self.image_info.setVisible(False)
