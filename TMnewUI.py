...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 701, 511))
        ...
        self.wvidemode = QtGui.QPushButton(self.centralwidget)
        self.wvidemode.setGeometry(QtCore.QRect(10, 610, 91, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wvidemode.setText(_translate("MainWindow", "Video Mode"))
